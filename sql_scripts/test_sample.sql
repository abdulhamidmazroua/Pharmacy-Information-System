...
INSERT INTO MEDICATION (name, description, primary_uom_code, exp_date, price, quantity, dosage_strength, created_by, last_update_by) VALUES
                                                                                                                                         ('Amoxicillin', 'Antibiotic used to treat a wide variety of bacterial infections.', 'MG', '2024-12-31', 5.00, 100, 500, 'system', 'system'),
                                                                                                                                         ('Ibuprofen', 'Nonsteroidal anti-inflammatory drug used for pain relief.', 'TAB', '2024-12-31', 0.20, 200, 200, 'system', 'system'),
                                                                                                                                         ('Vitamin C', 'Supplement used to prevent or treat low levels of vitamin C.', 'MG', '2025-01-31', 0.10, 300, 1000, 'system', 'system');
...
INSERT INTO MEDICATIONS_CATEGORIES (medication_id, category_id) VALUES
                                                                    (1, 1), -- Amoxicillin belongs to Antibiotics
                                                                    (2, 2), -- Ibuprofen belongs to Analgesics
                                                                    (3, 3); -- Vitamin C belongs to Vitamins
